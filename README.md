...
## 👨‍💻 Projects:
Created projects using PHP and MySQL<br>Developed a portfolio website showcasing my design skills using HTML, CSS, and JavaScript<br>Built a chat application using React and Firebase<br><br> Writing Shell Scripts and Process Scheduling Codes in Java.
